...
module.exports = {
  async play(song, message, client, filters) {
    ...
    if (!song) {
      ...
      const endembed = new MessageEmbed().setColor("#FF1818")
        .setAuthor(`Music Queue ended.`, "https://cdn.discordapp.com/attachments/799949974363832321/807557926403178516/end-phone-call-vector-icon-260nw-1069639583.jpg")
  ...
  let thumb;
    ...
    try {
      const newsong = new MessageEmbed()
        .setTitle("<a:tick:800021366152888396>"+song.title)
        .setURL(song.url)
        .setColor("#FF1818")
        .setThumbnail(thumb)
      ...
      switch (reaction.emoji.name) {
        ...
        case "🎵":
          ...
          splitDescription.forEach(async (m) => {
            ...
            message.react("<a:verified:800028816671375380>")
        ...
        case "⏭":
          ...
          const skipembed = new MessageEmbed().setColor("#FF1818").setAuthor(`${user.username} skipped the song.`, "https://cdn.discordapp.com/attachments/748633941912584333/753201474691137647/next.png")
        ...
        case "⏯":
          ...
          if (queue.playing) {
            ...
            const playembed = new MessageEmbed().setColor("#FF1818")
        ...
        case "🔄":
          ...
          const loopembed = new MessageEmbed().setColor("#FF1818")
            .setAuthor(`Loop is now ${queue.loop ? " enabled" : " disabled"}`, "https://cdn.discordapp.com/attachments/799949974363832321/807557232710516736/closed_loop_reporting_salesforce-277x300.jpg")
        ...
        case "⏹":
          ...
          if (!canModifyQueue(member)) return;
          queue.songs = [];
          const stopembed = new MessageEmbed().setColor("#FF1818").setAuthor(`${user.username} stopped the music!`, "https://cdn.discordapp.com/attachments/799949974363832321/807557926403178516/end-phone-call-vector-icon-260nw-1069639583.jpg")
